...
android {
    ...
    compileOptions {
        ...
        // desugaring to be enabled for :app". Desugaring back-ports java.time
        // and friends to the older API levels this app still supports.
    ...
    buildTypes {
        release {
            signingConfig = if (hasReleaseKeystore) {
                ...
                // build still produces an installable artifact.
...
dependencies {
    // The desugaring runtime that pairs with
    // `isCoreLibraryDesugaringEnabled = true` above.
